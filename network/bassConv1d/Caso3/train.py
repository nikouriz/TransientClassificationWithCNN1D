...
from bassdataset import BassDataset
...
EPOCHS = 25
LEARNING_RATE = 0.001
CSV_PATH = "network/bassConv1d/Caso3/datasets/BassDataset2.csv"
OUTPUT_PATH = "network/bassConv1d/Caso3/output"
NUM_LABELS = 12
...
if __name__ == "__main__":
    ...
    # Metricas para analizar el comportamiento de la red durante train y test
    mse_test = []
    mse_train = []
    mse_train_withtest = []
    accuracy_test = []
    ...
    # test
    with torch.no_grad():
        test(cnn, test_dataloader, device, True)

    plot_metrics(mse_train, mse_train_withtest, accuracy_train, accuracy_train_withtest)

    torch.save(cnn.state_dict(), f"{OUTPUT_PATH}/cnn1d.pth")
